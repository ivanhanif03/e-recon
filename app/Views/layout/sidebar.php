            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php if (in_groups('admin')) : ?>
                    ...
                    <li class="nav-item <?php if ($menu == 'pengguna' || $menu == 'hak_akses') {
                        ...
                        <a href="#" class="nav-link mb-2 <?php if ($menu == 'pengguna' || $menu == 'hak_akses') {
                                                                echo 'active';
                                                            } ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item mb-2">
                                <a href="<?= base_url('pengguna'); ?>" class="nav-link <?php if ($menu == 'pengguna') {
                                                                                            echo 'active';
                                                                                        } ?>">
                            ...
                            <li class="nav-item mb-2">
                                <a href="<?= base_url('hak_akses'); ?>" class="nav-link <?php if ($menu == 'hak_akses') {
                                                                                            echo 'active';
                                                                                        } ?>">
                    ...
                    <li class="nav-item mb-2">
                        <a href="<?= base_url('regional'); ?>" class="nav-link <?php if ($menu == 'regional') {
                                                                                    echo 'active';
                                                                                } ?>">
                    ...
                    <li class="nav-item mb-2">
                        <a href="<?= base_url('branch'); ?>" class="nav-link <?php if ($menu == 'branch') {
                                                                                    echo 'active';
                                                                                } ?>">
                    ...
                    <li class="nav-item mb-2">
                        <a href="<?= base_url('jenis_branch'); ?>" class="nav-link <?php if ($menu == 'jenis_branch') {
                                                                                        echo 'active';
                                                                                    } ?>">
                    ...
                    <li class="nav-item mb-2">
                        <a href="<?= base_url('klasifikasi_branch'); ?>" class="nav-link <?php if ($menu == 'klasifikasi_branch') {
                                                                                                echo 'active';
                                                                                            } ?>">
