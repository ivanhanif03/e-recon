                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-md-4 col-lg-2 float-end">
                                    <button type="button" data-toggle="modal" data-target="#modal-tambah-link"
                                        data-backdrop="static" class="btn btn-block bg-primary">Tambah Link<i
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <label>Branch</label>
                                <select
                                    class="form-control select2bs4 text-sm <?= ($validation->hasError('nama_branch')) ? 'is-invalid' : ''; ?>"
                                    name="nama_branch" id="nama_branch" style="width: 100%;">
                                    <option disabled="disabled" selected="selected">
                            ...
                            <div class="form-group">
                                <label>Provider</label>
                                <select
                                    class="form-control select2bs4 text-sm <?= ($validation->hasError('nama_provider')) ? 'is-invalid' : ''; ?>"
                                    name="nama_provider" id="nama_provider" style="width: 100%;">
                                    <option disabled="disabled" selected="selected">
                            ...
                            <div class="form-group">
                                <label>PIC</label>
                                <select
                                    class="form-control select2bs4 text-sm <?= ($validation->hasError('fullname')) ? 'is-invalid' : ''; ?>"
