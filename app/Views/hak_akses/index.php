                                    ...
                                    foreach ($hak_akses as $ha) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <!-- Edit -->
                                                <a href="" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-backdrop="static" data-target="#modal-edit-hak-akses<?= $ha['user_id'] ?>"><i class="nav-icon fas fa-edit"></i>
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="modal-edit-hak-akses<?= $ha['user_id'] ?>">
                                            <div class="modal-dialog modal-md">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?= base_url('/hakakses/update/') . '/' . $ha['user_id']; ?>" method="post">
                                                        <?= csrf_field(); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="hidden" name="user_id" id="user_id" value="<?= $ha['user_id']; ?>">
                                                                        <input type="text" class="form-control text-sm" name="username" id="username" value="<?= $ha['username']; ?>" readonly>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Hak Akses</label>
                                                                        <select class="form-control select2bs4 text-sm" name="group_id" id="group_id" style="width: 100%;">
                                                                            <option disabled="disabled" selected="selected">
                                                                                Pilih Hak Akses
                                                                            </option>
                                                                            <?php foreach ($role as $r) : ?>
                                                                                <option value="<?= $r['id']; ?>" <?php if ($r['name'] == $ha['name']) : ?>selected<?php endif; ?>>
                                                                                    <?= $r['name']; ?></option>
                                                                            <?php endforeach; ?>
                                                                        </select>
                                                                    </div>
